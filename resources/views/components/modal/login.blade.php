<div class="hidden modal overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="loginModal" >
    ...
    <div class="border-0 rounded-xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
        ...
        <p class="text-gray-400 mt-1 text-sm">
            Masukkan NIK dan password yang sudah terdaftar
        </p>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="relative p-6 flex-auto mx-10">
                <div class="mb-4">
                    ...
                    <input name="nik" class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs" id="nik" type="text" placeholder="Masukkan NIK" required>
                ...
                <div class="flex items-center justify-between">
                    <div class="inline-block text-xs text-gray-400">
                        <label class="inline-flex items-center mt-3">
                            <input type="checkbox" class="form-checkbox h-5 w-5 text-serv-button rounded border-serv-text"><span class="ml-2 text-gray-400">Simpan pengguna</span>
                        </label>
                    </div>
