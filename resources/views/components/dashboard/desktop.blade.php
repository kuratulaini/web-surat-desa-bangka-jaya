...
<aside class="z-20 flex-shrink-0 hidden w-64 overflow-y-auto bg-white md:block" aria-label="aside">
    <div class="text-serv-bg">
        <div class="" href="#">
            <img src="{{ url('https://bangkajaya.sigapaceh.id/assets/img/kab_acehutara.png') }}" alt="" class="object-center mx-auto my-8 w-16 h-16">
        </div>
        ...
        <div class="flex items-center pt-8 pl-5 space-x-2 border-t border-gray-100">
            ...
            <img class="object-cover object-center mr-1 rounded-full w-14 h-14"
                src="{{ url(Storage::url(Auth::user()->profile_photo_path)) }}" alt="random user" />
            <div>
                <!--Author name-->
        ...
        <ul>
            <li class="relative px-6 py-3">
                ...
                @if (request()->is('member/pengajuan_surat') ||
                    request()->is('member/pengajuan_surat/*') ||
                    request()->is('member/*/pengajuan_surat') ||
                    request()->is('member/*/pengajuan_surat/*')
                )
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg" aria-hidden="true"></span>
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="{{ route('member.pengajuan_surat.index') }}">
                    ...
                    <span class="ml-4">Pengajuan Surat</span>
            ...
            <li class="relative px-6 py-3">
                ...
                @if (request()->is('member/aduan') ||
                request()->is('member/aduan/*') ||
                request()->is('member/*/aduan') ||
                request()->is('member/*/aduan/*')
                )
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg" aria-hidden="true"></span>
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="{{ route('member.aduan.index') }}">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="ml-4">Aduan Warga</span>
